...
function Footer(props) {
    const { titleOne, titleTwo, titleThree, titleFour } = props.footerTitle
    return (
        <footer>
            <section className="footerLinks paddingY container">
                <div className="aboutFooter">
                    <h4 className="footerTitle">{titleOne}</h4>
                ...
                <div className="special">
                    <h4 className="footerTitle">{titleTwo}</h4>
                    <ul>
                ...
                <div className="hours">
                    <h4 className="footerTitle">{titleThree}</h4>
                    <ul>
                ...
                <div className="details">
                    <h4 className="footerTitle">{titleFour}</h4>
                    <ul>
